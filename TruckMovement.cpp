...
void TruckMovement::Move(char *filename)
{
	...
	while (counter == 0)
	{
		...
		vehicle = inst->createVehicle("LARGE_TRUCK", filename);
		...
		road = mapInst->getRoad("First Street");
...
void TruckMovement::PrintStatus()
{
